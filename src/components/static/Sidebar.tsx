...
const Sidebar = () => {
  return (
    <div className="grid grid-cols-1 gap-[30px] max-w-[360px] lglaptop:max-w-none laptop:col-span-4 h-fit">
      ...
      <div className='bg-absoluteWhite p-[20px] rounded-[10px]'>
        <p className='font-bold border-b-[1px] border-b-brandGrey pb-[5px]'>In this article</p>
